...
https://raw.githubusercontent.com/justinvh/Markdown-LaTeX/master/latex.py

Modified to work for my dev environment.
"""
...
_TEMPDIR = os.path.join(os.getcwd(), "markdown-latex")
...
"""
    ...
    def __init__(self, configs):
        ...
        self.config = {
            ("general", "preamble"): "",
            ("dvipng", "args"): "-q -T tight -bg Transparent -z 9 -D 160 -density=300",
            ("delimiters", "math"): "$",
            ("delimiters", "text"): "@",   
            ("delimiters", "preamble"): "%%"}
