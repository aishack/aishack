...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'aishack_tutorialread', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['aishack.AishackUser'])),
            ('tutorial', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['aishack.Tutorial'])),
            ('date', self.gf('django.db.models.fields.DateField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'aishack', ['TutorialRead'])


    def backwards(self, orm):
        # Deleting model 'TutorialRead'
        db.delete_table(u'aishack_tutorialread')
