...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AishackUser'
        db.create_table(u'aishack_aishackuser', (
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True, primary_key=True)),
            ('short_bio', self.gf('django.db.models.fields.CharField')(max_length=256)),
            ('bio', self.gf('django.db.models.fields.CharField')(max_length=2048)),
            ('website', self.gf('django.db.models.fields.URLField')(max_length=200)),
        ))
        db.send_create_signal(u'aishack', ['AishackUser'])


    def backwards(self, orm):
        # Deleting model 'AishackUser'
        db.delete_table(u'aishack_aishackuser')
