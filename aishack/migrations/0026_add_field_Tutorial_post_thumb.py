...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Tutorial.post_thumb'
        db.add_column(u'aishack_tutorial', 'post_thumb',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=256, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Tutorial.post_thumb'
        db.delete_column(u'aishack_tutorial', 'post_thumb')
    ...
    models = {
        ...
        u'aishack.tutorial': {
            ...
            'post_thumb': ('django.db.models.fields.files.ImageField', [], {'max_length': '256', 'null': 'True'}),
