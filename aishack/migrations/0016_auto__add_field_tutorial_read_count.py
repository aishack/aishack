...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Tutorial.read_count'
        db.add_column(u'aishack_tutorial', 'read_count',
                      self.gf('django.db.models.fields.BigIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Tutorial.read_count'
        db.delete_column(u'aishack_tutorial', 'read_count')
