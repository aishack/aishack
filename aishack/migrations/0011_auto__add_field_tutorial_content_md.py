...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Tutorial.content_md'
        db.add_column(u'aishack_tutorial', 'content_md',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Tutorial.content_md'
        db.delete_column(u'aishack_tutorial', 'content_md')
