...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TutorialSeries.name'
        db.add_column(u'aishack_tutorialseries', 'name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=256, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TutorialSeries.name'
        db.delete_column(u'aishack_tutorialseries', 'name')
