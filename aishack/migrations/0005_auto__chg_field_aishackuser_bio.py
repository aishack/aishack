...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AishackUser.bio'
        db.alter_column(u'aishack_aishackuser', 'bio', self.gf('django.db.models.fields.TextField')(max_length=2048))

    def backwards(self, orm):

        # Changing field 'AishackUser.bio'
        db.alter_column(u'aishack_aishackuser', 'bio', self.gf('django.db.models.fields.CharField')(max_length=2048))

    models = {
        u'aishack.aishackuser': {
            'Meta': {'object_name': 'AishackUser', '_ormbases': [u'auth.User']},
            'bio': ('django.db.models.fields.TextField', [], {'max_length': '2048'}),
            'short_bio': ('django.db.models.fields.CharField', [], {'max_length': '256'}),
