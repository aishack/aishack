...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TutorialSeriesOrder'
        db.create_table(u'aishack_tutorialseriesorder', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('series', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['aishack.TutorialSeries'])),
            ('tutorial', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['aishack.Tutorial'])),
            ('order', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal(u'aishack', ['TutorialSeriesOrder'])

        # Adding model 'TutorialSeries'
        db.create_table(u'aishack_tutorialseries', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal(u'aishack', ['TutorialSeries'])

        # Adding field 'Tutorial.series'
        db.add_column(u'aishack_tutorial', 'series',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['aishack.TutorialSeries'], blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'TutorialSeriesOrder'
        db.delete_table(u'aishack_tutorialseriesorder')

        # Deleting model 'TutorialSeries'
        db.delete_table(u'aishack_tutorialseries')

        # Deleting field 'Tutorial.series'
        db.delete_column(u'aishack_tutorial', 'series_id')
    ...
    models = {
        ...
        u'aishack.tutorial': {
            ...
            'series': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': u"orm['aishack.TutorialSeries']", 'blank': 'True'}),
            'slug': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '128'}),
        ...
        u'aishack.tutorialseriesorder': {
            'Meta': {'object_name': 'TutorialSeriesOrder'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'order': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
