...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field related on 'Tutorial'
        m2m_table_name = db.shorten_name(u'aishack_tutorial_related')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('from_tutorial', models.ForeignKey(orm[u'aishack.tutorial'], null=False)),
            ('to_tutorial', models.ForeignKey(orm[u'aishack.tutorial'], null=False))
        ))
        db.create_unique(m2m_table_name, ['from_tutorial_id', 'to_tutorial_id'])


    def backwards(self, orm):
        # Removing M2M table for field related on 'Tutorial'
        db.delete_table(db.shorten_name(u'aishack_tutorial_related'))
    ...
    models = {
        ...
        u'aishack.tutorial': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'post_image': ('django.db.models.fields.CharField', [], {'max_length': '256'}),
            'related': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'related_rel_+'", 'to': u"orm['aishack.Tutorial']"}),
            'slug': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '128'}),
