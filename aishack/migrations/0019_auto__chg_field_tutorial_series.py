...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Tutorial.series'
        db.alter_column(u'aishack_tutorial', 'series_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['aishack.TutorialSeries'], null=True))

    def backwards(self, orm):

        # Changing field 'Tutorial.series'
        db.alter_column(u'aishack_tutorial', 'series_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['aishack.TutorialSeries']))
