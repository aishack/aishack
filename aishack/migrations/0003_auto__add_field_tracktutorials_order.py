...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TrackTutorials.order'
        db.add_column(u'aishack_tracktutorials', 'order',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TrackTutorials.order'
        db.delete_column(u'aishack_tracktutorials', 'order')
